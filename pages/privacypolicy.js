    ...
    <div className="my-10 text-black">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <p className="leading-6">
          Effective date: 2022-12-10 <br />
          <br />
          Welcome to WeddingPlanners.
          <br />
          WeddingPlanners us, we, or our operates WeddingPlanners.com hereinafter referred
          to as Service.
          <br />
          Our Privacy Policy governs your visit to WeddingPlanners.com, and explains
        ...
        <br />
        <h1 className="text-xl  font-semibold">2. Definitions</h1>
        <p className="leading-6">
          SERVICE means the WeddingPlanners.com website operated by WeddingPlanners.
          <br />
          ...
          duration of a page visit. COOKIES are small files stored on your
        ...
        <br />
        <h1 className="text-lg  font-semibold">4.Types of Data Collected</h1>
        <p className="leading-6">
          Personal Data
          <br />
          ...
          unique device identifiers and other diagnostic data. Location Data
          <br />
          ...
          at any time by way of your device settings. Tracking Cookies Data
          <br />
        ...
        <br />
        <h1 className="text-xl  font-semibold">5. Use of Data</h1>
        <p className="leading-6">
          WeddingPlanners uses the collected data for various purposes:
          <br />
          ...
          <br />
          0.4. to provide customer care and support;
          <br />
          0.5. to provide analysis or valuable information so that we can
          improve the Service;
          <br />
          0.6. to monitor the usage of the Service;
          <br />
        ...
        <br />
        <h1 className="text-xl  font-semibold">6. Retention of Data</h1>
        <p className="leading-6">
          ...
          agreements and policies. <br /> We will also retain Usage Data for
        ...
        <br />
        <h1 className="text-xl  font-semibold">7. Transfer of Data</h1>
        <p className="leading-6">
          ...
          transfer. WeddingPlanners will take all steps reasonably necessary to ensure
          that your data is treated securely and in accordance with this Privacy
          Policy and no transfer of your Personal Data will take place to an
          organization or a country unless there are adequate controls in place
          including the security of your data and other personal information We
        ...
        <br />
        <h1 className="text-xl  font-semibold">8. Disclosure of Data</h1>
        <p className="leading-6">
        ...
        <br />
        <h1 className="text-xl  font-semibold">9. Security of Data</h1>
        <p className="leading-6">
        ...
        <p className="leading-6">
          ...
          info@WeddingPlanners.com. In certain circumstances, you have the following
          ...
          and commonly used format; 0.6. the right to withdraw consent. You also
          have the right to withdraw your consent at any time where we rely on
          ...
          necessary data. You have the right to complain to a Data Protection
          ...
          us at info@WeddingPlanners.com.
          <br />
          ...
          Track browser mechanism is in place. Do Not Track is a preference you
          ...
          company we shared it with. Please note, you are entitled to ask us to
          ...
          you in the previous 12 months. 0.2. To delete your personal
          ...
          information to operate. 0.3. To stop selling your personal
          information. We don’t sell or rent your personal information to any
          third parties for any purpose. We do not sell your personal
          ...
          for exercising your rights. To exercise your California data
          protection rights described above, please send your request(s) by
          email: info@WeddingPlanners.com. Your data protection rights, described
          ...
          for any other purpose. 14. Analytics
          <br />
          We may use third-party Service Providers to monitor and analyze the
          use of our Service. 15. CI/CD tools
          <br />
          We may use third-party Service Providers to automate the development
          process of our Service. 16. Advertising
          <br />
          We may use third-party Service Providers to show advertisements to you
          to help support and maintain our Service. 17. Behavioral Remarketing
          <br />
          ...
          visits to our Service. 18. Payments
          <br />
          ...
          payment information. 19. Links to Other Sites
          <br />
          ...
          third party sites or services. For example, the outlined privacy
          ...
          blog, website, e-commerce store or mobile app. 20. Children’s Privacy
          <br />
        ...
        <p>
          ...
          by email: info@WeddingPlanners.com.
        </p>
      </div>
    </div>
  );
