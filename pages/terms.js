...
const terms = () => {
  return (
    <div className="my-10 ">
      <br />{" "}
      <h1 className="text-3xl font-bold text-center">Terms &amp; Condition </h1>
      <div className="max-w-7xl mx-auto">
        <br /> <h1 className="text-xl  font-semibold">1. Introduction</h1>
        <p>
          Welcome to WeddingPlanners (“Company”, “we”, “our”, “us”)! <br />
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at WeddingPlanners.com (together or individually
          “Service”) operated by WeddingPlanners. Our Privacy Policy also governs your
          ...
          info@WeddingPlanners.com so we can try to find a solution. These Terms apply
          to all visitors, users and others who wish to access or use Service.
          <br />
        </p>
        <br /> <h1 className="text-xl  font-semibold">2. Communications</h1>
        <p>
          ...
          info@WeddingPlanners.com.
        </p>
        <br /> <h1 className="text-xl  font-semibold">3. Purchases</h1>
        <p>
        ...
        <br /> <h1 className="text-xl  font-semibold">5. Refunds</h1>
        <p>
          We issue refunds for Contracts within 7 days of the original purchase
          of the Contract.
        </p>
        <br /> <h1 className="text-xl  font-semibold">6. Content</h1>
        <p>
          Content found on or through this Service are the property of WeddingPlanners
        ...
        <br /> <h1 className="text-xl  font-semibold">7. Prohibited Uses</h1>
        <p>
          You may use Service only for lawful purposes and in accordance with
          Terms. You agree not to use Service: <br />
          ...
          liability. Additionally, you agree not to: <br />
          ...
          copying any of the material on Service. <br />
        ...
        <br /> <h1 className="text-xl  font-semibold">8. Analytics</h1>
        <p>
          We may use third-party Service Providers to monitor and analyze the
          use of our Service.
        </p>
        <br /> <h1 className="text-xl  font-semibold">9. No Use By Minors</h1>
        <p>
        ...
        <br /> <h1 className="text-xl  font-semibold">10. Accounts</h1>
        <p>
        ...
        <br />{" "}
        <h1 className="text-xl  font-semibold">11. Intellectual Property</h1>
        <p>
          Service and its original content (excluding Content provided by
          users), features and functionality are and will remain the exclusive
          property of WeddingPlanners and its licensors. Service is protected by
          ...
          without the prior written consent of WeddingPlanners.
        </p>
        <br /> <h1 className="text-xl  font-semibold">12. Copyright Policy</h1>
        <p>
          ...
          info@WeddingPlanners.com, with the subject line: “Copyright Infringement”
          ...
          Copyright Infringement Claims” You may be held accountable for damages
        ...
        <p>
          ...
          act on behalf of the owner of the copyright’s interest; <br />
          ...
          where the material that you claim is infringing is located; <br />
          ...
          You can contact our Copyright Agent via email at info@WeddingPlanners.com.
        </p>
        <br />{" "}
        <h1 className="text-xl  font-semibold">
        ...
        <p>
          You may provide us either directly at info@WeddingPlanners.com or via third
        ...
        <br />{" "}
        <h1 className="text-xl  font-semibold">15. Links To Other Web Sites</h1>
        <p>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by WeddingPlanners. WeddingPlanners has no
          ...
          YOU TO READ THE TERMS OF SERVICE AND PRIVACY POLICIES OF ANY THIRD
          PARTY WEB SITES OR SERVICES THAT YOU VISIT.
        </p>
        <br />{" "}
        <h1 className="text-xl  font-semibold">16. Disclaimer Of Warranty</h1>
        <p>
          ...
          ANY SERVICES OR ITEMS OBTAINED FROM US IS AT YOUR SOLE RISK. <br />
        ...
        <br />{" "}
        <h1 className="text-xl  font-semibold">17. Limitation Of Liability</h1>
        <p>
        ...
        <br /> <h1 className="text-xl  font-semibold">18. Termination</h1>
        <p>
        ...
        <br /> <h1 className="text-xl  font-semibold">19. Governing Law</h1>
        <p>
          These Terms shall be governed and construed in accordance with the
          laws of India, which governing law applies to agreement without regard
          to its conflict of law provisions. <br />
        ...
        <br />{" "}
        <h1 className="text-xl  font-semibold">20. Changes To Service</h1>
        <p>
        ...
        <br />{" "}
        <h1 className="text-xl  font-semibold">21. Amendments To Terms</h1>
        <p>
          ...
          23. Acknowledgement <br />
          BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE
          THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY
          THEM.
        </p>
        <br /> <h1 className="text-xl  font-semibold">24. Contact Us</h1>
        <p>
